...
DEB_DOWNLOAD_URL="http://ftp.unicamp.br/pub/tdf/libreoffice/stable/${VERSION}/deb/x86_64/LibreOffice_${VERSION}_Linux_x86-64_deb.tar.gz"
...
MESA_DOWNLOAD_URL="ftp://ftp.freedesktop.org/pub/mesa/17.0.0/mesa-17.0.0.tar.xz"
